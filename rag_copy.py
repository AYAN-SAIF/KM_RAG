...
if not api_key:
    raise ValueError("❌ OPENAI_API_KEY not found. Make sure your .env file exists and contains the correct key.")
else:
    os.environ["OPENAI_API_KEY"] = api_key
    print("✅ OPENAI_API_KEY loaded successfully.")

PDF_PATH = "C:/Users/Lenovo/Desktop/Kausar_medico/documents/KAUSAR MEDICO.pdf"  # change to your file
...
def split_documents(docs, chunk_size=250, chunk_overlap=50):
